...
describe('Directive: dashboard', function () {
  ...
  describe('the openWidgetSettings function', function() {
    ...
    it('should set the templateUrl in modal options to the default ("client/components/adf/directives/dashboard/widget-settings-template.html")', function() {
      var widget = {};
      var dfr = $q.defer();
      spyOn(mockModal, 'open').and.callFake(function(options) {
        modalOptions = options;
      ...
      childScope.openWidgetSettings(widget);
      expect(modalOptions.templateUrl).toEqual('client/components/adf/directives/dashboard/widget-settings-template.html');
    });
