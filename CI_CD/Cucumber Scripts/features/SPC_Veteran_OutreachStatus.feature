...
Scenario: I open a web browser and use http://localhost:7003/ to see the Veteran's Outreach Status in veteran roaster widget
  ...
  Then I should see the roster widget with list of Veterans "Veteran roster"
  And I should see a column "OutReach Status" in  the veterans roster widget
  And I should see "Not Contacted" in the outreach status column
  And I should see "Outreach Initiated" in the outreach status column
  And I should see "Outreach Attempted – No Response" in the outreach status column
