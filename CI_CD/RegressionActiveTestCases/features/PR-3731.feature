Feature: AAs a Perceptive Reach Dashboard user, I want to see instructions for how to email the help desk on the log in screen before I log in, so I know what to do if I need help.. PR-3731
